...
global_detailed_headers <- read.csv(file.path(params$ref_lib_path, params$taxa_division, params$locus, params$region_of_interest, params$step_2a_analysis_date, paste0(params$step_2a_analysis_date, "_", params$region_of_interest, "_completeDB.csv")))
