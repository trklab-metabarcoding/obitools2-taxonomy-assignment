...
# filter out by min_read_length for all sample_ columns - sum by column
...
#### Median and max for global counts
```{r}
# median for global counts
print(paste0("The median counts across all taxa for the global keep set: ", median(global_keep$count)))
