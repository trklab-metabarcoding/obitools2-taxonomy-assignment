...
local_ref_db <- file.path(params$ref_lib_path, params$project_code, params$locus, params$region_of_interest, params$latest_db_date, sprintf("formatdb_%s_%s", params$project_code, params$locus), sprintf("%s_%s_%s", params$project_code, params$locus, params$latest_db_date)) 
#-d in ecotag; ecoPCR taxonomy Database name.

file.copy(file.path(params$ref_lib_path, params$project_code, params$locus, params$region_of_interest, params$latest_db_date, sprintf("%s_TAXO", params$latest_db_date)), file.path(params$ref_lib_path, params$project_code, params$locus, params$region_of_interest, params$latest_db_date, sprintf("formatdb_%s_%s", params$project_code, params$locus)), recursive = TRUE)

ref_seq <- file.path(params$ref_lib_path, params$project_code, params$locus, params$region_of_interest, params$latest_db_date, sprintf("%s%s_completeDB_%s.fasta", params$project_code, params$region_of_interest, params$latest_db_date)) 
