...
params:
  ...
  seq_dates = []
  output_path = 
  #do update params below this line:
  rundate: 20240308 # start date in YYYYMMDD
  local_fasta: "trnL_library_20230414.fas"
  project_code: "YNP"
  locus: "trnL"
...
local_ref_db<-file.path("/oscar/data/tkartzin/local_ref_lib_plants/params$project_code/params$project_code_params$locus_params$rundate") #-d in ecotag; ecoPCR taxonomy Database name. Need to edit YYYYMMDD and name of taxonomy database to match that of the most recent global reference library you want to use.

ref_seq<-file.path("/oscar/data/tkartzin/local_ref_lib_plants/params$project_code/params$rundate/db_YYYYMMDD_P6set.fasta") #-R in ecotag; fasta file containing the reference sequences. Need to edit YYYYMMDD and name of fasta file to match that of the most recent global reference library you want to use. 
```
