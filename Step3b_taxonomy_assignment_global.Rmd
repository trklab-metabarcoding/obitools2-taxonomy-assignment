...
global_ref_db <- file.path(params$ref_lib_path, params$taxa_division, params$region_of_interest, params$latest_db_date, sprintf("%s_ecoPCRformat", params$latest_db_date))
# -d in ecotag; ecoPCR taxonomy Database name.

ref_seq <- file.path(params$ref_lib_path, params$taxa_division, params$region_of_interest, params$latest_db_date, sprintf("%s_%s_completeDB.fasta", params$latest_db_date, params$region_of_interest))
