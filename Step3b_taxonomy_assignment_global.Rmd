...
ref_seq <- file.path(params$ref_lib_path, params$taxa_division, params$region_of_interest, params$latest_db_date, sprintf("db_%s_%sset.fasta", params$latest_db_date, params$region_of_interest))
