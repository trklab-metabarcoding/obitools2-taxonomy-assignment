...
params:
  ...
  step_2a_analysis_date: "20241227"
  step_2b_analysis_date: "20241108"
  step_3b_analysis_date: '20240502'
  step_3c_analysis_date: '20240502'
  project_code: test
  taxa_division: PLN
...
pacman::p_load(knitr, here, tidyr, dplyr, phyloseq, vegan, vegetarian, scales, datawizard, ggplot2, ggrepel, glue, textshape, stringr)
...
global_detailed_headers <- read.csv(file.path(params$global_ref_lib_path, params$taxa_division, params$locus, params$region_of_interest, params$step_2a_analysis_date, paste0(params$step_2a_analysis_date, "_", params$region_of_interest, "_completeDB.csv")))
...
```{r}
print(paste0("The median counts for the local keep subset: ", median(local_keep$count))) 
print(paste0("The median counts for the global keep subset: ", median(global_keep$count)))
print(paste0("The maximum counts for the local keep subset: ", max(local_keep$count))) 
print(paste0("The maximum counts for the global keep subset: ", max(global_keep$count)))
```
<br>
