...
here::i_am("./Step4b_create_phyloseq_globalandlocal.Rmd")
```
...
file.copy(phyloseq_object, file.path(paste0("{output_path}/", filename)), overwrite = TRUE)

file.copy("./Step4b_create_phyloseq_globalandlocal.nb.html", file.path(glue("{output_path}/Step4b_create_phyloseq_globalandlocal.nb.html")), overwrite = TRUE)
```
