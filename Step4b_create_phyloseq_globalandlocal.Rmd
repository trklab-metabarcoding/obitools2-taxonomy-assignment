...
#### Plot proportions from each subset by species
```{r warning=FALSE}
sample_depths %>% 
...
```{r warning=FALSE}
local_nontrace_global_stats <- as.data.frame(cbind(tapply(local_nontrace_global_depth, paste(data_samples$Season, data_samples$Species), mean), tapply(local_nontrace_global_depth, paste(data_samples$Season, data_samples$Species), sd), tapply(local_nontrace_global_depth, paste(data_samples$Season, data_samples$Species), function(x) length(x))))
